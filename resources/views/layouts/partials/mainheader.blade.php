...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini">
            <img src="{{asset('/img/logo_transparente.png')}}" style="width:38px;" class="centered" alt="User Image"/>
        </span>
        <div class="row centered  logo-lg">
            {{-- <img src="{{asset('/img/logo_largo_transparente.png')}}" style="width:160px;height:40px;" class="centered" alt="User Image"/> --}}
            <h3><b>DENUNCIAS</b></h3>
        </div>
